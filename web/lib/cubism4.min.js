...
! function(t, e) {
        ...
        updateParameters(t, e) {
            ...
            switch (this._blinkingState) {
                case h.EyeState_Closing:
                    s = (this._userTimeSeconds - this._stateStartTimeSeconds) / this._closingSeconds, s >= 1 && (s = 1, this._blinkingState = h.EyeState_Closed, this._stateStartTimeSeconds = this._userTimeSeconds), i = 1 - s;
                    break;
                case h.EyeState_Closed:
                    s = (this._userTimeSeconds - this._stateStartTimeSeconds) / this._closedSeconds, s >= 1 && (this._blinkingState = h.EyeState_Opening, this._stateStartTimeSeconds = this._userTimeSeconds), i = 0;
                    break;
                case h.EyeState_Opening:
                    s = (this._userTimeSeconds - this._stateStartTimeSeconds) / this._openingSeconds, s >= 1 && (s = 1, this._blinkingState = h.EyeState_Interval, this._nextBlinkingTime = this.determinNextBlinkingTiming()), i = s;
                    break;
                case h.EyeState_Interval:
                    this._nextBlinkingTime < this._userTimeSeconds && (this._blinkingState = h.EyeState_Closing, this._stateStartTimeSeconds = this._userTimeSeconds), i = 1;
                    break;
                case h.EyeState_First:
                default:
                    this._blinkingState = h.EyeState_Interval, this._nextBlinkingTime = this.determinNextBlinkingTiming(), i = 1
            }
            n.CloseIfZero || (i = -i);
    ...
    let l = n;
    l.CloseIfZero = !0;
    var h = (t => (t[t.EyeState_First = 0] = "EyeState_First", t[t.EyeState_Interval = 1] = "EyeState_Interval", t[t.EyeState_Closing = 2] = "EyeState_Closing", t[t.EyeState_Closed = 3] = "EyeState_Closed", t[t.EyeState_Opening = 4] = "EyeState_Opening", t))(h || {});
    class u {
        static create(t) {
            const e = new u;
    ...
    const m = class {
        ...
        static quadraticEquation(t, e, i) {
            return this.abs(t) < m.Epsilon ? this.abs(e) < m.Epsilon ? -i : -i / e : -(e + this.sqrt(e * e - 4 * t * i)) / (2 * t)
        }
        static cardanoAlgorithmForBezier(t, e, i, s) {
            if (this.sqrt(t) < m.Epsilon) return this.range(this.quadraticEquation(e, i, s), 0, 1);
            const r = e / t,
                a = i / t,
                o = (3 * a - r * r) / 3,
                n = o / 3,
    ...
    class _ {
        ...
        constructor() {
            this._isCulling = !1, this._isPremultipliedAlpha = !1, this._anisortopy = 0, this._modelColor = new y, this._mvpMatrix4x4 = new p, this._mvpMatrix4x4.loadIdentity()
        }
    }
    var f = (t => (t[t.CubismBlendMode_Normal = 0] = "CubismBlendMode_Normal", t[t.CubismBlendMode_Additive = 1] = "CubismBlendMode_Additive", t[t.CubismBlendMode_Multiplicative = 2] = "CubismBlendMode_Multiplicative", t))(f || {});
    class y {
        constructor() {
    ...
    class C {
        static startUp(t) {
            ...
            if (Live2DCubismCore._isStarted = !0, x = t, x && Live2DCubismCore.Logging.csmSetLogFunction(x.logFunction), v = !0, v) {
                const t = Live2DCubismCore.Version.csmGetVersion(),
                    e = (16711680 & t) >> 16,
                    i = 65535 & t,
                    s = t;
                I("Live2D Cubism Core version: {0}.{1}.{2} ({3})", ("00" + ((4278190080 & t) >> 24)).slice(-2), ("00" + e).slice(-2), ("0000" + i).slice(-4), s)
            }
        ...
        static initialize() {
            v ? M ? L("CubismFramework.initialize() skipped, already initialized.") : (M = !0, I("CubismFramework.initialize() is complete.")) : L("CubismFramework is not started.")
        }
        static dispose() {
            v ? M ? (_.staticRelease(), M = !1, I("CubismFramework.dispose() is complete.")) : L("CubismFramework.dispose() skipped, not initialized.") : L("CubismFramework is not started.")
        }
        static isStarted() {
            return v
        }
    ...
    var S = (t => (t[t.LogLevel_Verbose = 0] = "LogLevel_Verbose", t[t.LogLevel_Debug = 1] = "LogLevel_Debug", t[t.LogLevel_Info = 2] = "LogLevel_Info", t[t.LogLevel_Warning = 3] = "LogLevel_Warning", t[t.LogLevel_Error = 4] = "LogLevel_Error", t[t.LogLevel_Off = 5] = "LogLevel_Off", t))(S || {});
    const b = () => {};
    ...
    class D {
        ...
        getDrawableBlendMode(t) {
            const e = this._model.drawables.constantFlags;
            return Live2DCubismCore.Utils.hasBlendAdditiveBit(e[t]) ? f.CubismBlendMode_Additive : Live2DCubismCore.Utils.hasBlendMultiplicativeBit(e[t]) ? f.CubismBlendMode_Multiplicative : f.CubismBlendMode_Normal
        }
    ...
    class B {
        ...
        parseUserData(t, e) {
            ...
            for (let r = 0; r < s; r++) {
                ...
                this._userDataNodes.push(t), "ArtMesh" == t.targetType && this._artMeshUserDataNode.push(t)
            }
            i.release()
        }
        constructor() {
    ...
    class R {
        ...
        updateParameters(t, e, i) {
            ...
            let s = this._weight;
            s = s * (0 == this._fadeInSeconds ? 1 : g.getEasingSine((i - e.getFadeInStartTime()) / this._fadeInSeconds)) * (0 == this._fadeOutSeconds || e.getEndTime() < 0 ? 1 : g.getEasingSine((e.getEndTime() - i) / this._fadeOutSeconds)), e.setState(i, s), this.doUpdateParameters(t, i, s, e), e.getEndTime() > 0 && e.getEndTime() < i && e.setIsFinished(!0)
        }
        setFadeInTime(t) {
    ...
    var k, U = (t => (t[t.ExpressionBlendType_Add = 0] = "ExpressionBlendType_Add", t[t.ExpressionBlendType_Multiply = 1] = "ExpressionBlendType_Multiply", t[t.ExpressionBlendType_Overwrite = 2] = "ExpressionBlendType_Overwrite", t))(U || {});
    t.CubismConfig = void 0, (k = t.CubismConfig || (t.CubismConfig = {})).supportMoreMaskDivisions = !0, k.setOpacityFromMotion = !1;
    var N = (t => (t[t.CubismMotionCurveTarget_Model = 0] = "CubismMotionCurveTarget_Model", t[t.CubismMotionCurveTarget_Parameter = 1] = "CubismMotionCurveTarget_Parameter", t[t.CubismMotionCurveTarget_PartOpacity = 2] = "CubismMotionCurveTarget_PartOpacity", t))(N || {}),
        V = (t => (t[t.CubismMotionSegmentType_Linear = 0] = "CubismMotionSegmentType_Linear", t[t.CubismMotionSegmentType_Bezier = 1] = "CubismMotionSegmentType_Bezier", t[t.CubismMotionSegmentType_Stepped = 2] = "CubismMotionSegmentType_Stepped", t[t.CubismMotionSegmentType_InverseStepped = 3] = "CubismMotionSegmentType_InverseStepped", t))(V || {});
    class j {
        constructor(t = 0, e = 0) {
    ...
    class H {
        ...
        getEvaluationOptionFlag(t) {
            return Y.EvaluationOptionFlag_AreBeziersRistricted == t && !!this._json.Meta.AreBeziersRestricted
        }
        getMotionCurveCount() {
    ...
    var Y = (t => (t[t.EvaluationOptionFlag_AreBeziersRistricted = 0] = "EvaluationOptionFlag_AreBeziersRistricted", t))(Y || {});
    ...
    function tt(t, e, i) {
        ...
        for (let l = s.baseSegmentIndex; l < a; ++l)
            if (o = t.segments[l].basePointIndex + (t.segments[l].segmentType == V.CubismMotionSegmentType_Bezier ? 3 : 1), t.points[o].time > i) {
                r = l;
                break
    ...
    class et extends R {
        ...
        doUpdateParameters(e, i, s, r) {
            ...
            let h = 0,
                u = 0;
            this._eyeBlinkParameterIds.length > l && w("too many eye blink targets : {0}", this._eyeBlinkParameterIds.length), this._lipSyncParameterIds.length > l && w("too many lip sync targets : {0}", this._lipSyncParameterIds.length);
            const d = this._fadeInSeconds <= 0 ? 1 : g.getEasingSine((i - r.getFadeInStartTime()) / this._fadeInSeconds),
                c = this._fadeOutSeconds <= 0 || r.getEndTime() < 0 ? 1 : g.getEasingSine((r.getEndTime() - i) / this._fadeOutSeconds);
            let m, p, _, f = a;
            if (this._isLoop)
                for (; f > this._motionData.duration;) f -= this._motionData.duration;
            const y = this._motionData.curves;
            for (p = 0; p < this._motionData.curveCount && y[p].type == N.CubismMotionCurveTarget_Model; ++p) m = tt(this._motionData, p, f), y[p].id == this._modelCurveIdEyeBlink ? n = m : y[p].id == this._modelCurveIdLipSync && (o = m);
            for (; p < this._motionData.curveCount && y[p].type == N.CubismMotionCurveTarget_Parameter; ++p) {
                ...
                if (y[p].fadeInTime < 0 && y[p].fadeOutTime < 0) a = t + (m - t) * s;
                    ...
                    let e, s;
                    e = y[p].fadeInTime < 0 ? d : 0 == y[p].fadeInTime ? 1 : g.getEasingSine((i - r.getFadeInStartTime()) / y[p].fadeInTime), s = y[p].fadeOutTime < 0 ? c : 0 == y[p].fadeOutTime || r.getEndTime() < 0 ? 1 : g.getEasingSine((r.getEndTime() - i) / y[p].fadeOutTime);
            ...
            for (; p < this._motionData.curveCount && y[p].type == N.CubismMotionCurveTarget_PartOpacity; ++p)
                if (m = tt(this._motionData, p, f), t.CubismConfig.setOpacityFromMotion) e.setPartOpacityById(y[p].id, m);
                else {
                    if (_ = e.getParameterIndex(y[p].id), -1 == _) continue;
                    e.setParameterValueByIndex(_, m)
                } a >= this._motionData.duration && (this._isLoop ? (r.setStartTime(i), this._isLoopFadeIn && r.setFadeInStartTime(i)) : (this._onFinishedMotion && this._onFinishedMotion(this), r.setIsFinished(!0))), this._lastWeight = s
        }
        setIsLoop(t) {
            this._isLoop = t
        }
        ...
        parse(t) {
            ...
            const i = e.getEvaluationOptionFlag(Y.EvaluationOptionFlag_AreBeziersRistricted),
            ...
            }).map((() => new X)), this._motionData.segments = Array.from({
                length: e.getMotionTotalSegmentCount()
            }).map((() => new G)), this._motionData.events = Array.from({
                length: this._motionData.eventCount
            }).map((() => new z)), this._motionData.points = [];
            let a = 0,
                o = 0;
            for (let n = 0; n < this._motionData.curveCount; ++n) {
                ...
                switch (e.getMotionCurveTarget(n)) {
                    ...
                    case "PartOpacity":
                        ...
                        break;
                    default:
                        L('Warning : Unable to get segment type from Curve! The number of "CurveCount" may be incorrect!')
                }
                ...
                for (let l = 0; l < e.getMotionCurveSegmentCount(n);) {
                    0 == l ? (this._motionData.segments[o].basePointIndex = a, this._motionData.points[a] = new j(e.getMotionCurveSegment(n, l), e.getMotionCurveSegment(n, l + 1)), a += 1, l += 2) : this._motionData.segments[o].basePointIndex = a - 1;
                    switch (e.getMotionCurveSegment(n, l)) {
                        case V.CubismMotionSegmentType_Linear:
                            this._motionData.segments[o].segmentType = V.CubismMotionSegmentType_Linear, this._motionData.segments[o].evaluate = $, this._motionData.points[a] = new j(e.getMotionCurveSegment(n, l + 1), e.getMotionCurveSegment(n, l + 2)), a += 1, l += 3;
                            break;
                        case V.CubismMotionSegmentType_Bezier:
                            this._motionData.segments[o].segmentType = V.CubismMotionSegmentType_Bezier, this._motionData.segments[o].evaluate = i ? Z : J, this._motionData.points[a] = new j(e.getMotionCurveSegment(n, l + 1), e.getMotionCurveSegment(n, l + 2)), this._motionData.points[a + 1] = new j(e.getMotionCurveSegment(n, l + 3), e.getMotionCurveSegment(n, l + 4)), this._motionData.points[a + 2] = new j(e.getMotionCurveSegment(n, l + 5), e.getMotionCurveSegment(n, l + 6)), a += 3, l += 7;
                            break;
                        case V.CubismMotionSegmentType_Stepped:
                            this._motionData.segments[o].segmentType = V.CubismMotionSegmentType_Stepped, this._motionData.segments[o].evaluate = Q, this._motionData.points[a] = new j(e.getMotionCurveSegment(n, l + 1), e.getMotionCurveSegment(n, l + 2)), a += 1, l += 3;
                            break;
                        case V.CubismMotionSegmentType_InverseStepped:
                            this._motionData.segments[o].segmentType = V.CubismMotionSegmentType_InverseStepped, this._motionData.segments[o].evaluate = K, this._motionData.points[a] = new j(e.getMotionCurveSegment(n, l + 1), e.getMotionCurveSegment(n, l + 2)), a += 1, l += 3
                    }++t.segmentCount, ++o
                }
    ...
    class st {
        ...
        startMotion(t, e, i) {
            ...
            return s = new it, s._autoDelete = e, s._motion = t, this._motions.push(s), s._motionQueueEntryHandle
        }
        isFinished() {
            let t = 0;
    ...
    const rt = -1;
    var at = (t => (t[t.CubismPhysicsTargetType_Parameter = 0] = "CubismPhysicsTargetType_Parameter", t))(at || {}),
        ot = (t => (t[t.CubismPhysicsSource_X = 0] = "CubismPhysicsSource_X", t[t.CubismPhysicsSource_Y = 1] = "CubismPhysicsSource_Y", t[t.CubismPhysicsSource_Angle = 2] = "CubismPhysicsSource_Angle", t))(ot || {});
    class nt {
        constructor() {
    ...
    class dt {
        constructor() {
            this.settings = [], this.inputs = [], this.outputs = [], this.particles = [], this.gravity = new c(0, 0), this.wind = new c(0, 0)
        }
    }
    class ct {
        constructor(t) {
    ...
    class gt {
        ...
        evaluate(t, e) {
            ...
            const o = new c;
            let n, l, h, u, d, m, p, _;
            d = t.getModel().parameters.values, m = t.getModel().parameters.maximumValues, p = t.getModel().parameters.minimumValues, _ = t.getModel().parameters.defaultValues;
            for (let f = 0; f < this._physicsRig.subRigCount; ++f) {
                i = {
                    angle: 0
                }, o.x = 0, o.y = 0, n = this._physicsRig.settings[f], l = this._physicsRig.inputs.slice(n.baseInputIndex), h = this._physicsRig.outputs.slice(n.baseOutputIndex), u = this._physicsRig.particles.slice(n.baseParticleIndex);
                for (let e = 0; e < n.inputCount; ++e) s = l[e].weight / 100, -1 == l[e].sourceParameterIndex && (l[e].sourceParameterIndex = t.getParameterIndex(l[e].source.id)), l[e].getNormalizedParameterValue(o, i, d[l[e].sourceParameterIndex], p[l[e].sourceParameterIndex], m[l[e].sourceParameterIndex], _[l[e].sourceParameterIndex], n.normalizationPosition, n.normalizationAngle, l[e].reflect, s);
                r = g.degreesToRadian(-i.angle), o.x = o.x * g.cos(r) - o.y * g.sin(r), o.y = o.x * g.sin(r) + o.y * g.cos(r), wt(u, n.particleCount, o, i.angle, this._options.wind, .001 * n.normalizationPosition.maximum, e, 5);
                for (let e = 0; e < n.outputCount; ++e) {
                    ...
                    const s = new c;
                    s.x = u[i].position.x - u[i - 1].position.x, s.y = u[i].position.y - u[i - 1].position.y, a = h[e].getValue(s, u, i, h[e].reflect, this._options.gravity);
                    const r = h[e].destinationParameterIndex,
                        o = !Float32Array.prototype.slice && "subarray" in Float32Array.prototype ? JSON.parse(JSON.stringify(d.subarray(r))) : d.slice(r);
                    It(o, p[r], m[r], a, h[e]);
        ...
        constructor() {
            this._options = new pt, this._options.gravity.y = -1, this._options.gravity.x = 0, this._options.wind.x = 0, this._options.wind.y = 0
        }
        release() {
            ...
            for (let a = 0; a < this._physicsRig.subRigCount; ++a) {
                ...
                for (let i = 0; i < t.inputCount; ++i) {
                    ...
                    switch (t.sourceParameterIndex = -1, t.weight = e.getInputWeight(a, i), t.reflect = e.getInputReflect(a, i), e.getInputType(a, i)) {
                        case "X":
                            t.type = ot.CubismPhysicsSource_X, t.getNormalizedParameterValue = _t;
                            break;
                        case "Y":
                            t.type = ot.CubismPhysicsSource_Y, t.getNormalizedParameterValue = ft;
                            break;
                        case mt:
                            t.type = ot.CubismPhysicsSource_Angle, t.getNormalizedParameterValue = yt
                    }
                    t.source.targetType = at.CubismPhysicsTargetType_Parameter, t.source.id = e.getInputSourceId(a, i), this._physicsRig.inputs.push(t)
                }
                t.outputCount = e.getOutputCount(a), t.baseOutputIndex = s, s += t.outputCount;
                for (let i = 0; i < t.outputCount; ++i) {
                    const t = new ut;
                    switch (t.destinationParameterIndex = -1, t.vertexIndex = e.getOutputVertexIndex(a, i), t.angleScale = e.getOutputAngleScale(a, i), t.weight = e.getOutputWeight(a, i), t.destination.targetType = at.CubismPhysicsTargetType_Parameter, t.destination.id = e.getOutputDestinationId(a, i), e.getOutputType(a, i)) {
                        case "X":
                            t.type = ot.CubismPhysicsSource_X, t.getValue = xt, t.getScale = Ct;
                            break;
                        case "Y":
                            t.type = ot.CubismPhysicsSource_Y, t.getValue = vt, t.getScale = St;
                            break;
                        case mt:
                            t.type = ot.CubismPhysicsSource_Angle, t.getValue = Mt, t.getScale = bt
                    }
        ...
        initialize() {
            ...
            for (let s = 0; s < this._physicsRig.subRigCount; ++s) {
                e = this._physicsRig.settings[s], t = this._physicsRig.particles.slice(e.baseParticleIndex), t[0].initialPosition = new c(0, 0), t[0].lastPosition = new c(t[0].initialPosition.x, t[0].initialPosition.y), t[0].lastGravity = new c(0, -1), t[0].lastGravity.y *= -1, t[0].velocity = new c(0, 0), t[0].force = new c(0, 0);
                for (let s = 1; s < e.particleCount; ++s) i = new c(0, 0), i.y = t[s].radius, t[s].initialPosition = new c(t[s - 1].initialPosition.x + i.x, t[s - 1].initialPosition.y + i.y), t[s].position = new c(t[s].initialPosition.x, t[s].initialPosition.y), t[s].lastPosition = new c(t[s].initialPosition.x, t[s].initialPosition.y), t[s].lastGravity = new c(0, -1), t[s].lastGravity.y *= -1, t[s].velocity = new c(0, 0), t[s].force = new c(0, 0)
            }
        }
    }
    class pt {
    ...
    function Mt(t, e, i, s, r) {
        let a;
        return r = i >= 2 ? e[i - 1].position.substract(e[i - 2].position) : r.multiplyByScaler(-1), a = g.directionToRadian(r, t), s && (a *= -1), a
    }
    ...
    class At {
        ...
        getMaskRenderTexture() {
            ...
            if (this._maskTexture && 0 != this._maskTexture.texture && (this._maskTexture.frameNo = this._currentFrameNo, t = this._maskTexture.texture), 0 == t) {
                ...
                this._colorBuffer = this.gl.createTexture(), this.gl.bindTexture(this.gl.TEXTURE_2D, this._colorBuffer), this.gl.texImage2D(this.gl.TEXTURE_2D, 0, this.gl.RGBA, e, e, 0, this.gl.RGBA, this.gl.UNSIGNED_BYTE, null), this.gl.texParameteri(this.gl.TEXTURE_2D, this.gl.TEXTURE_WRAP_S, this.gl.CLAMP_TO_EDGE), this.gl.texParameteri(this.gl.TEXTURE_2D, this.gl.TEXTURE_WRAP_T, this.gl.CLAMP_TO_EDGE), this.gl.texParameteri(this.gl.TEXTURE_2D, this.gl.TEXTURE_MIN_FILTER, this.gl.LINEAR), this.gl.texParameteri(this.gl.TEXTURE_2D, this.gl.TEXTURE_MAG_FILTER, this.gl.LINEAR), this.gl.bindTexture(this.gl.TEXTURE_2D, null), t = this.gl.createFramebuffer(), this.gl.bindFramebuffer(this.gl.FRAMEBUFFER, t), this.gl.framebufferTexture2D(this.gl.FRAMEBUFFER, this.gl.COLOR_ATTACHMENT0, this.gl.TEXTURE_2D, this._colorBuffer, 0), this.gl.bindFramebuffer(this.gl.FRAMEBUFFER, Ft), this._maskTexture = new Bt(this._currentFrameNo, t)
            }
            return t
        }
        setGL(t) {
        ...
        calcClippedDrawTotalBounds(t, e) {
            ...
            for (let n = 0; n < o; n++) {
                ...
                for (let t = P.vertexOffset; t < g; t += P.vertexStep) {
                    const e = h[t],
                        i = h[t + 1];
                    e < u && (u = e), e > c && (c = e), i < d && (d = i), i > m && (m = i)
                }
                if (u != Number.MAX_VALUE)
                    if (u < i && (i = u), d < s && (s = d), c > r && (r = c), m > a && (a = m), i == Number.MAX_VALUE) e._allClippedDrawRect.x = 0, e._allClippedDrawRect.y = 0, e._allClippedDrawRect.width = 0, e._allClippedDrawRect.height = 0, e._isUsing = !1;
                    else {
                        e._isUsing = !0;
                        const t = r - i,
                            o = a - s;
        ...
        constructor() {
            ...
            let t = new y;
            t.R = 1, t.G = 0, t.B = 0, t.A = 0, this._channelColors.push(t), t = new y, t.R = 0, t.G = 1, t.B = 0, t.A = 0, this._channelColors.push(t), t = new y, t.R = 0, t.G = 0, t.B = 1, t.A = 0, this._channelColors.push(t), t = new y, t.R = 0, t.G = 0, t.B = 0, t.A = 1, this._channelColors.push(t)
        }
        release() {
            var t, e, i;
            const s = this;
        ...
        initialize(t, e, i, s) {
            for (let r = 0; r < e; r++) {
                ...
                null == t && (t = new Rt(this, i[r], s[r]), this._clippingContextListForMask.push(t)), t.addClippedDrawable(r), this._clippingContextListForDraw.push(t)
            }
        }
        setupClippingContext(t, e) {
            ...
            if (i > 0) {
                ...
                this.gl.bindFramebuffer(this.gl.FRAMEBUFFER, Ft), e.setClippingContextBufferForMask(null), this.gl.viewport(Dt[0], Dt[1], Dt[2], Dt[3])
            }
        }
        findSameClip(t, e) {
            for (let i = 0; i < this._clippingContextListForMask.length; i++) {
        ...
        setupLayoutBounds(e) {
            ...
            for (let a = 0; a < 4; a++) {
                ...
                if (0 == e);
                    ...
                    t._layoutChannelNo = a, t._layoutBounds.x = 0, t._layoutBounds.y = 0, t._layoutBounds.width = 1, t._layoutBounds.height = 1
                } else if (2 == e)
                    for (let t = 0; t < e; t++) {
                        let e = t % 2;
                        e = ~~e;
                        const i = this._clippingContextListForMask[r++];
                        i._layoutChannelNo = a, i._layoutBounds.x = .5 * e, i._layoutBounds.y = 0, i._layoutBounds.width = .5, i._layoutBounds.height = 1
                    } else if (e <= 4)
                        for (let t = 0; t < e; t++) {
                            let e = t % 2,
                                i = t / 2;
                            ...
                            s._layoutChannelNo = a, s._layoutBounds.x = .5 * e, s._layoutBounds.y = .5 * i, s._layoutBounds.width = .5, s._layoutBounds.height = .5
                        } else if (e <= 9)
                            for (let t = 0; t < e; t++) {
                                let e = t % 3,
                                    i = t / 3;
                                e = ~~e, i = ~~i;
                                const s = this._clippingContextListForMask[r++];
                                s._layoutChannelNo = a, s._layoutBounds.x = e / 3, s._layoutBounds.y = i / 3, s._layoutBounds.width = 1 / 3, s._layoutBounds.height = 1 / 3
                                ...
                                for (let t = 0; t < e; t++) {
                                    ...
                                    e = ~~e, i = ~~i;
                                    const s = this._clippingContextListForMask[r++];
                                    s._layoutChannelNo = a, s._layoutBounds.x = e / 4, s._layoutBounds.y = i / 4, s._layoutBounds.width = 1 / 4, s._layoutBounds.height = 1 / 4
    ...
    class Rt {
        constructor(t, e, i) {
            this._isUsing = !1, this._owner = t, this._clippingIdList = e, this._clippingIdCount = i, this._allClippedDrawRect = new Tt, this._layoutBounds = new Tt, this._clippedDrawableIndexList = [], this._matrixForMask = new p, this._matrixForDraw = new p
        }
        release() {
            const t = this;
    ...
    class Ot {
        ...
        setupShaderProgram(t, e, i, s, r, a, o, n, l, h, u, d, c) {
            let m, g, p, _;
            u || T("NoPremultipliedAlpha is not allowed"), 0 == this._shaderSets.length && this.generateShaders();
            ...
            if (null != y) {
                ...
                this.gl.uniform4f(t.uniformChannelFlagLocation, r.R, r.G, r.B, r.A), this.gl.uniformMatrix4fv(t.uniformClipMatrixLocation, !1, y._matrixForMask.getArray());
                const n = y._layoutBounds;
                this.gl.uniform4f(t.uniformBaseColorLocation, 2 * n.x - 1, 2 * n.y - 1, 2 * n.getRight() - 1, 2 * n.getBottom() - 1), m = this.gl.ZERO, g = this.gl.ONE_MINUS_SRC_COLOR, p = this.gl.ZERO, _ = this.gl.ONE_MINUS_SRC_ALPHA
            } else {
                ...
                switch (l) {
                    ...
                    default:
                        n = this._shaderSets[kt.ShaderNames_NormalPremultipliedAlpha + r], m = this.gl.ONE, g = this.gl.ONE_MINUS_SRC_ALPHA, p = this.gl.ONE, _ = this.gl.ONE_MINUS_SRC_ALPHA;
                        break;
                    case f.CubismBlendMode_Additive:
                        n = this._shaderSets[kt.ShaderNames_AddPremultipliedAlpha + r], m = this.gl.ONE, g = this.gl.ONE, p = this.gl.ZERO, _ = this.gl.ONE;
                        break;
                    case f.CubismBlendMode_Multiplicative:
                        n = this._shaderSets[kt.ShaderNames_MultPremultipliedAlpha + r], m = this.gl.DST_COLOR, g = this.gl.ONE_MINUS_SRC_ALPHA, p = this.gl.ZERO, _ = this.gl.ONE
                }
                ...
                this.gl.activeTexture(this.gl.TEXTURE0), this.gl.bindTexture(this.gl.TEXTURE_2D, e), this.gl.uniform1i(n.samplerTexture0Location, 0), this.gl.uniformMatrix4fv(n.uniformMatrixLocation, !1, d.getArray()), this.gl.uniform4f(n.uniformBaseColorLocation, h.R, h.G, h.B, h.A)
            }
            null == o.index && (o.index = this.gl.createBuffer()), this.gl.bindBuffer(this.gl.ELEMENT_ARRAY_BUFFER, o.index), this.gl.bufferData(this.gl.ELEMENT_ARRAY_BUFFER, r, this.gl.DYNAMIC_DRAW), this.gl.blendFuncSeparate(m, g, p, _)
        }
        ...
        loadShaderProgram(t, e) {
            ...
            return this.gl.getProgramParameter(i, this.gl.LINK_STATUS) ? (this.gl.deleteShader(s), this.gl.deleteShader(r), i) : (T("Failed to link program: {0}", i), this.gl.deleteShader(s), this.gl.deleteShader(r), i && this.gl.deleteProgram(i), 0)
        }
    ...
    var kt = (t => (t[t.ShaderNames_SetupMask = 0] = "ShaderNames_SetupMask", t[t.ShaderNames_NormalPremultipliedAlpha = 1] = "ShaderNames_NormalPremultipliedAlpha", t[t.ShaderNames_NormalMaskedPremultipliedAlpha = 2] = "ShaderNames_NormalMaskedPremultipliedAlpha", t[t.ShaderNames_NomralMaskedInvertedPremultipliedAlpha = 3] = "ShaderNames_NomralMaskedInvertedPremultipliedAlpha", t[t.ShaderNames_AddPremultipliedAlpha = 4] = "ShaderNames_AddPremultipliedAlpha", t[t.ShaderNames_AddMaskedPremultipliedAlpha = 5] = "ShaderNames_AddMaskedPremultipliedAlpha", t[t.ShaderNames_AddMaskedPremultipliedAlphaInverted = 6] = "ShaderNames_AddMaskedPremultipliedAlphaInverted", t[t.ShaderNames_MultPremultipliedAlpha = 7] = "ShaderNames_MultPremultipliedAlpha", t[t.ShaderNames_MultMaskedPremultipliedAlpha = 8] = "ShaderNames_MultMaskedPremultipliedAlpha", t[t.ShaderNames_MultMaskedPremultipliedAlphaInverted = 9] = "ShaderNames_MultMaskedPremultipliedAlphaInverted", t))(kt || {});
    const Ut = "attribute vec4     a_position;attribute vec2     a_texCoord;varying vec2       v_texCoord;varying vec4       v_myPos;uniform mat4       u_clipMatrix;void main(){   gl_Position = u_clipMatrix * a_position;   v_myPos = u_clipMatrix * a_position;   v_texCoord = a_texCoord;   v_texCoord.y = 1.0 - v_texCoord.y;}",
        Nt = "precision mediump float;varying vec2       v_texCoord;varying vec4       v_myPos;uniform vec4       u_baseColor;uniform vec4       u_channelFlag;uniform sampler2D  s_texture0;void main(){   float isInside =        step(u_baseColor.x, v_myPos.x/v_myPos.w)       * step(u_baseColor.y, v_myPos.y/v_myPos.w)       * step(v_myPos.x/v_myPos.w, u_baseColor.z)       * step(v_myPos.y/v_myPos.w, u_baseColor.w);   gl_FragColor = u_channelFlag * texture2D(s_texture0, v_texCoord).a * isInside;}",
        Vt = "attribute vec4     a_position;attribute vec2     a_texCoord;varying vec2       v_texCoord;uniform mat4       u_matrix;void main(){   gl_Position = u_matrix * a_position;   v_texCoord = a_texCoord;   v_texCoord.y = 1.0 - v_texCoord.y;}",
        jt = "attribute vec4     a_position;attribute vec2     a_texCoord;varying vec2       v_texCoord;varying vec4       v_clipPos;uniform mat4       u_matrix;uniform mat4       u_clipMatrix;void main(){   gl_Position = u_matrix * a_position;   v_clipPos = u_clipMatrix * a_position;   v_texCoord = a_texCoord;   v_texCoord.y = 1.0 - v_texCoord.y;}",
        Gt = "precision mediump float;varying vec2       v_texCoord;uniform vec4       u_baseColor;uniform sampler2D  s_texture0;void main(){   gl_FragColor = texture2D(s_texture0 , v_texCoord) * u_baseColor;}",
        Xt = "precision mediump float;varying vec2       v_texCoord;varying vec4       v_clipPos;uniform vec4       u_baseColor;uniform vec4       u_channelFlag;uniform sampler2D  s_texture0;uniform sampler2D  s_texture1;void main(){   vec4 col_formask = texture2D(s_texture0 , v_texCoord) * u_baseColor;   vec4 clipMask = (1.0 - texture2D(s_texture1, v_clipPos.xy / v_clipPos.w)) * u_channelFlag;   float maskVal = clipMask.r + clipMask.g + clipMask.b + clipMask.a;   col_formask = col_formask * maskVal;   gl_FragColor = col_formask;}",
        zt = "precision mediump float;varying vec2 v_texCoord;varying vec4 v_clipPos;uniform sampler2D s_texture0;uniform sampler2D s_texture1;uniform vec4 u_channelFlag;uniform vec4 u_baseColor;void main(){vec4 col_formask = texture2D(s_texture0, v_texCoord) * u_baseColor;vec4 clipMask = (1.0 - texture2D(s_texture1, v_clipPos.xy / v_clipPos.w)) * u_channelFlag;float maskVal = clipMask.r + clipMask.g + clipMask.b + clipMask.a;col_formask = col_formask * (1.0 - maskVal);gl_FragColor = col_formask;}";
    class Wt extends _ {
        constructor() {
        ...
        drawMesh(t, e, i, s, r, a, o, n, l) {
            ...
            let u = null;
            null != this._textures[t] && (u = this._textures[t]), Ot.getInstance().setupShaderProgram(this, u, i, r, s, a, this._bufferData, o, n, h, this.isPremultipliedAlpha(), this.getMvpMatrix(), l), this.gl.drawElements(this.gl.TRIANGLES, e, this.gl.UNSIGNED_SHORT, 0), this.gl.useProgram(null), this.setClippingContextBufferForDraw(null), this.setClippingContextBufferForMask(null)
        }
    ...
    const Yt = "ParamAngleX",
        ...
        Kt = "ParamBreath";
    var te;
    t.config = void 0, (te = t.config || (t.config = {})).LOG_LEVEL_VERBOSE = 0, te.LOG_LEVEL_WARNING = 1, te.LOG_LEVEL_ERROR = 2, te.LOG_LEVEL_NONE = 999, te.logLevel = te.LOG_LEVEL_WARNING, te.sound = !0, te.motionSync = !0, te.motionFadingDuration = 500, te.idleMotionFadingDuration = 2e3, te.expressionFadingDuration = 500, te.preserveExpressionOnMotion = !0, te.cubism4 = t.CubismConfig;
    const ee = {
        log(e, ...i) {
    ...
    class oe extends e.EventEmitter {
        ...
        loadExpression(t) {
            return __async(this, null, (function*() {
                if (!this.definitions[t]) return void ee.warn(this.tag, `Undefined expression at [${t}]`);
                if (null === this.expressions[t]) return void ee.warn(this.tag, `Cannot set expression at [${t}] because it's already failed in loading.`);
    ...
    class ne {
        ...
        update(t) {
            ...
            const h = Math.sqrt(__pow(this.vx, 2) + __pow(this.vy, 2)),
                u = .5 * (Math.sqrt(__pow(l, 2) + 8 * l * s) - l);
            h > u && (this.vx *= u / h, this.vy *= u / h), this.x += this.vx, this.y += this.vy
        }
    }
    class le {
        constructor(t) {
    ...
    var he = (t => (t[t.NONE = 0] = "NONE", t[t.IDLE = 1] = "IDLE", t[t.NORMAL = 2] = "NORMAL", t[t.FORCE = 3] = "FORCE", t))(he || {});
    class ue {
        constructor() {
            this.debug = !1, this.currentPriority = 0, this.reservePriority = 0
        }
        reserve(t, e, i) {
            if (i <= 0) return ee.log(this.tag, "Cannot start a motion with MotionPriority.NONE."), !1;
            if (t === this.currentGroup && e === this.currentIndex) return ee.log(this.tag, "Motion is already playing.", this.dump(t, e)), !1;
            if (t === this.reservedGroup && e === this.reservedIndex || t === this.reservedIdleGroup && e === this.reservedIdleIndex) return ee.log(this.tag, "Motion is already reserved.", this.dump(t, e)), !1;
            if (1 === i) {
                if (0 !== this.currentPriority) return ee.log(this.tag, "Cannot start idle motion because another motion is playing.", this.dump(t, e)), !1;
                if (void 0 !== this.reservedIdleGroup) return ee.log(this.tag, "Cannot start idle motion because another idle motion has reserved.", this.dump(t, e)), !1;
                this.setReservedIdle(t, e)
            } else {
                if (i < 3) {
                    if (i <= this.currentPriority) return ee.log(this.tag, "Cannot start motion because another motion is playing as an equivalent or higher priority.", this.dump(t, e)), !1;
                    if (i <= this.reservePriority) return ee.log(this.tag, "Cannot start motion because another motion has reserved as an equivalent or higher priority.", this.dump(t, e)), !1
                }
        ...
        start(t, e, i, s) {
            if (1 === s) {
                if (this.setReservedIdle(void 0, void 0), 0 !== this.currentPriority) return ee.log(this.tag, "Cannot start idle motion because another motion is playing.", this.dump(e, i)), !1
            } else {
                if (e !== this.reservedGroup || i !== this.reservedIndex) return ee.log(this.tag, "Cannot start motion because another motion has taken the place.", this.dump(e, i)), !1;
    ...
    class de {
        ...
        static add(t, e, i) {
            ...
            return s.volume = this._volume, s.preload = "auto", s.addEventListener("ended", (() => {
                ...
                this.dispose(s), ee.warn("SoundManager", `Error occurred on "${t}"`, e.error), null == i || i(e.error)
    ...
    de.audios = [], de._volume = .5;
    var ce = (t => (t.ALL = "ALL", t.IDLE = "IDLE", t.NONE = "NONE", t))(ce || {});
    class me extends e.EventEmitter {
        constructor(t, e) {
            super(), this.motionGroups = {}, this.state = new ue, this.playing = !1, this.destroyed = !1, this.settings = t, this.tag = `MotionManager(${t.name})`, this.state.tag = this.tag
        }
        init(t) {
        ...
        loadMotion(t, e) {
            return __async(this, null, (function*() {
                var i;
                if (!(null == (i = this.definitions[t]) ? void 0 : i[e])) return void ee.warn(this.tag, `Undefined motion at "${t}"[${e}]`);
                if (null === this.motionGroups[t][e]) return void ee.warn(this.tag, `Cannot start motion at "${t}"[${e}] because it's already failed in loading.`);
        ...
        startMotion(e, i) {
            return __async(this, arguments, (function*(e, i, s = he.NORMAL) {
                ...
                if (!a) return !1;
                let o;
                if (this.currentAudio && de.dispose(this.currentAudio), t.config.sound) {
                    const t = this.getSoundFile(a);
                    if (t) try {
                        o = de.add(this.settings.resolveURL(t), (() => this.currentAudio = void 0), (() => this.currentAudio = void 0)), this.currentAudio = o
                    } catch (l) {
                ...
                if (o) {
                    const e = de.play(o).catch((t => ee.warn(this.tag, "Failed to play audio", o.src, t)));
                    t.config.motionSync && (yield e)
                }
                return this.state.start(n, e, i, s) ? (ee.log(this.tag, "Start motion:", this.getMotionName(a)), this.emit("motionStart", e, i, o), this.state.shouldOverrideExpression() && this.expressionManager && this.expressionManager.resetExpression(), this.playing = !0, this._startMotion(n), !0) : (o && (de.dispose(o), this.currentAudio = void 0), !1)
            }))
        }
        ...
        stopAllMotions() {
            this._stopAllMotions(), this.state.reset(), this.currentAudio && (de.dispose(this.currentAudio), this.currentAudio = void 0)
        }
        update(t, e) {
            var i;
            return this.isFinished() && (this.playing && (this.playing = !1, this.emit("motionFinish")), this.state.shouldOverrideExpression() && (null == (i = this.expressionManager) || i.restoreExpression()), this.state.complete(), this.state.shouldRequestIdleMotion() && this.startRandomMotion(this.groups.idle, he.IDLE)), this.updateParameters(t, e)
        }
        destroy() {
            var t;
    ...
    class pe extends e.EventEmitter {
        constructor() {
            super(...arguments), this.focusController = new ne, this.originalWidth = 0, this.originalHeight = 0, this.width = 0, this.height = 0, this.localTransform = new i.Matrix, this.drawingMatrix = new i.Matrix, this.hitAreas = {}, this.textureFlipY = !1, this.viewport = [0, 0, 0, 0], this.destroyed = !1
        }
        init() {
    ...
    const fe = class {
        static createXHR(t, e, i, s, r) {
            ...
            if (fe.allXhrSet.add(a), t) {
                ...
                e ? e.add(a) : (e = new Set([a]), fe.xhrMap.set(t, e)), t.listeners("destroy").includes(fe.cancelXHRs) || t.once("destroy", fe.cancelXHRs)
            }
            return a.open("GET", e), a.responseType = i, a.onload = () => {
                200 !== a.status && 0 !== a.status || !a.response ? a.onerror() : s(a.response)
            }, a.onerror = () => {
                ee.warn("XHRLoader", `Failed to load resource as ${a.responseType} (Status ${a.status}): ${e}`), r(new _e("Network error.", e, a.status))
            }, a.onabort = () => r(new _e("Aborted.", e, a.status, !0)), a.onloadend = () => {
                var e;
                fe.allXhrSet.delete(a), t && (null == (e = fe.xhrMap.get(t)) || e.delete(a))
            }, a
        }
        static cancelXHRs() {
            var t;
            null == (t = fe.xhrMap.get(this)) || t.forEach((t => {
                t.abort(), fe.allXhrSet.delete(t)
            })), fe.xhrMap.delete(this)
        }
        static release() {
            fe.allXhrSet.forEach((t => t.abort())), fe.allXhrSet.clear(), fe.xhrMap = new WeakMap
        }
    };
    let ye = fe;
    ...
    ye.xhrMap = new WeakMap, ye.allXhrSet = new Set, ye.loader = (t, e) => new Promise(((e, i) => {
        fe.createXHR(t.target, t.settings ? t.settings.resolveURL(t.url) : t.url, t.type, (i => {
            t.result = i, e()
        }), i).send()
    }));
    class ve {
    ...
    const Me = "Live2DFactory",
        Pe = (t, e) => __async(this, null, (function*() {
        ...
        Ce = (t, e) => __async(this, null, (function*() {
        ...
        be = (t, e) => __async(this, null, (function*() {
            yield e();
            ...
            if (i) {
                ...
                if (s) {
                    ...
                    e.pose && r.push(ve.load({
                        ...
                        t.live2dModel.emit("poseLoadError", e), ee.warn(Me, "Failed to load pose.", e)
                    }))), e.physics && r.push(ve.load({
                        settings: e,
                        url: e.physics,
                        type: "json",
                        target: i
                        ...
                        t.live2dModel.emit("physicsLoadError", e), ee.warn(Me, "Failed to load physics.", e)
                    }))), r.length && (yield Promise.all(r))
                }
            }
        })),
        we = (t, e) => __async(this, null, (function*() {
        ...
        Ie = (t, e) => __async(this, null, (function*() {
            const i = t.settings;
            if (i instanceof le) {
        ...
        Le = class {
            ...
            static loadMotion(t, e, i) {
                ...
                try {
                    ...
                    return null != n[i] || (n[i] = ve.load({
                        ...
                        var r;
                        const o = null == (r = Le.motionTasksMap.get(t)) ? void 0 : r[e];
                        o && delete o[i];
            ...
            static releaseTasks() {
                this instanceof me ? Le.motionTasksMap.delete(this) : Le.expressionTasksMap.delete(this)
            }
        };
    let Te = Le;
    Te.runtimes = [], Te.urlToJSON = Pe, Te.jsonToSettings = Ce, Te.waitUntilReady = Se, Te.setupOptionals = be, Te.setupEssentials = we, Te.createInternalModel = Ie, Te.live2DModelMiddlewares = [Pe, Ce, Se, be, we, Ie], Te.motionTasksMap = new WeakMap, Te.expressionTasksMap = new WeakMap, me.prototype._loadMotion = function(t, e) {
    ...
    class Ee {
        ...
        set autoInteract(t) {
            t !== this._autoInteract && (t ? this.on("pointertap", De, this) : this.off("pointertap", De, this), this._autoInteract = t)
        }
        registerInteraction(t) {
            t !== this.interactionManager && (this.unregisterInteraction(), this._autoInteract && t && (this.interactionManager = t, t.on("pointermove", Fe, this)))
        }
        unregisterInteraction() {
            var t;
            this.interactionManager && (null == (t = this.interactionManager) || t.off("pointermove", Fe, this), this.interactionManager = void 0)
        }
    }
    ...
    class ke extends r.Container {
        constructor(t) {
            super(), this.tag = "Live2DModel(uninitialized)", this.textures = [], this.transform = new Ae, this.anchor = new i.ObservablePoint(this.onAnchorChange, this, 0, 0), this.glContextID = -1, this.elapsedTime = performance.now(), this.deltaTime = 0, this._autoUpdate = !1, this.once("modelLoaded", (() => this.init(t)))
        }
        static from(t, e) {
            const i = new this(e);
        ...
        static fromSync(t, e) {
            const i = new this(e);
            return Te.setupLive2DModel(i, t, e).then(null == e ? void 0 : e.onLoad).catch(null == e ? void 0 : e.onError), i
        }
        ...
        set autoUpdate(t) {
            var e;
            Oe || (Oe = null == (e = window.PIXI) ? void 0 : e.Ticker), t ? this._destroyed || (Oe ? (Oe.shared.add(this.onTickerUpdate, this), this._autoUpdate = !0) : ee.warn(this.tag, "No Ticker registered, please call Live2DModel.registerTicker(Ticker).")) : (null == Oe || Oe.shared.remove(this.onTickerUpdate, this), this._autoUpdate = !1)
        }
        init(t) {
        ...
        hitTest(t, e) {
            return Be.x = t, Be.y = e, this.toModelPosition(Be, Be), this.internalModel.hitTest(Be.x, Be.y)
        }
        ...
        _render(t) {
            ...
            const s = Re.copyFrom(t.globalUniforms.uniforms.projectionMatrix).append(this.worldTransform);
    ...
    const Ue = class {
        ...
        static createSettings(t) {
            return __async(this, null, (function*() {
                ...
                const i = yield Ue.readText(e), s = JSON.parse(i);
    ...
    let Ne = Ue;
    Ne.filesMap = {}, Ne.factory = (t, e) => __async(this, null, (function*() {
        if (Array.isArray(t.source) && t.source[0] instanceof File) {
            ...
            i.validateFiles(e.map((t => encodeURI(t.webkitRelativePath)))), yield Ue.upload(e, i), i.resolveURL = function(t) {
                ...
                t.once("destroy", (function() {
                    ...
                    if (URL.revokeObjectURL(t), Ue.filesMap[t])
                        for (const e of Object.values(Ue.filesMap[t])) URL.revokeObjectURL(e);
    ...
    const Ve = class {
        static unzip(t, i) {
            return __async(this, null, (function*() {
                const s = yield Ve.getFilePaths(t), r = [];
        ...
        static createSettings(t) {
            return __async(this, null, (function*() {
                const e = (yield Ve.getFilePaths(t)).find((t => t.endsWith("model.json") || t.endsWith("model3.json")));
    ...
    let je = Ve;
    if (je.ZIP_PROTOCOL = "zip://", je.uid = 0, je.factory = (t, e) => __async(this, null, (function*() {
            const i = t.source;
            let s, r, a;
            if ("string" == typeof i && (i.endsWith(".zip") || i.startsWith(Ve.ZIP_PROTOCOL)) ? (s = i.startsWith(Ve.ZIP_PROTOCOL) ? i.slice(Ve.ZIP_PROTOCOL.length) : i, r = yield ve.load({
                    url: s,
                    type: "blob",
                    target: t.live2dModel
                ...
                a || (a = yield Ve.createSettings(e)), a._objectURL = Ve.ZIP_PROTOCOL + Ve.uid + "/" + a.url;
            ...
            return e()
        })), Te.live2DModelMiddlewares.unshift(je.factory), !window.Live2DCubismCore) throw new Error("Could not find Cubism 4 runtime. This plugin requires live2dcubismcore.js to be loaded.");
    class Ge extends oe {
        constructor(t, e) {
            var i;
            super(t, e), this.queueManager = new st, this.definitions = null != (i = t.expressions) ? i : [], this.init()
        }
        isFinished() {
    ...
    class ze extends me {
        constructor(t, e) {
            ...
            super(t, e), this.groups = {
                idle: "Idle"
            }, this.motionDataType = "json", this.queueManager = new st, this.definitions = null != (i = t.motions) ? i : {}, this.eyeBlinkIds = t.getEyeBlinkParameters() || [], this.lipSyncIds = t.getLipSyncParameters() || [], this.init(e)
        }
        init(t) {
            super.init(t), this.settings.expressions && (this.expressionManager = new Ge(this.settings, t)), this.queueManager.setEventCallback(((t, e, i) => {
                this.emit("motion:" + e)
            }))
        }
        isFinished() {
    ...
    class He extends pe {
        constructor(t, e, s) {
            super(), this.lipSync = !0, this.breath = a.create(), this.renderer = new Wt, this.idParamAngleX = Yt, this.idParamAngleY = qt, this.idParamAngleZ = $t, this.idParamEyeBallX = Zt, this.idParamEyeBallY = Jt, this.idParamBodyAngleX = Qt, this.idParamBreath = Kt, this.pixelsPerUnit = 1, this.centeringTransform = new i.Matrix, this.coreModel = t, this.settings = e, this.motionManager = new ze(e, s), this.init()
        }
        init() {
            var t;
            super.init(), (null == (t = this.settings.getEyeBlinkParameters()) ? void 0 : t.length) > 0 && (this.eyeBlink = l.create(this.settings)), this.breath.setParameters([new o(this.idParamAngleX, 0, 15, 6.5345, .5), new o(this.idParamAngleY, 0, 8, 3.5345, .5), new o(this.idParamAngleZ, 0, 10, 5.5345, .5), new o(this.idParamBodyAngleX, 0, 4, 15.5345, .5), new o(this.idParamBreath, 0, .5, 3.2345, .5)]), this.renderer.initialize(this.coreModel), this.renderer.setIsPremultipliedAlpha(!0)
        }
        getSize() {
        ...
        updateWebGLContext(t, e) {
            this.renderer.firstDraw = !0, this.renderer._bufferData = {
                ...
                uv: null,
                index: null
            }, this.renderer.startUp(t), this.renderer._clippingManager._currentFrameNo = e, this.renderer._clippingManager._maskTexture = void 0, Ot.getInstance()._shaderSets = []
        }
        bindTexture(t, e) {
        ...
        draw(t) {
            const e = this.drawingMatrix,
                i = We.getArray();
            i[0] = e.a, i[1] = e.b, i[4] = -e.c, i[5] = -e.d, i[12] = e.tx, i[13] = e.ty, this.renderer.setMvpMatrix(We), this.renderer.setRenderState(t.getParameter(t.FRAMEBUFFER_BINDING), this.viewport), this.renderer.drawModel()
        }
        destroy() {
    ...
    function $e() {
        return C.isStarted() ? Promise.resolve() : (null != Ye || (Ye = new Promise(((t, e) => {
            ! function i() {
                try {
                    Ze(), t()
                } catch (s) {
                    ...
                    ee.log("Cubism4", "Startup failed, retrying 10ms later..."), setTimeout(i, 10)
                }
            }()
        }))), Ye)
    }
    ...
    function Ze(t) {
        t = Object.assign({
            ...
            loggingLevel: S.LogLevel_Verbose
        }, t), C.startUp(t), C.initialize()
    }
